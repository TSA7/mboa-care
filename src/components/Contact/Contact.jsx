    ...
    <div className='bg-white ' >
      ...
      <div className=' relative bottom-50 lg:bottom-20'>
        ...
        <div className=' flex justify-center'>
            <div  className=' flex justify-between items-center p-3 backgroundContact gap-10' style={{borderRadius:'20px'}}>
              <img ref={heightlenght} src='contact.png'/>
              <div className=' flex flex-col gap-3'>
                <Localisation icon={<LocationOnIcon sx={{size:29}}/>} classname={'locationBackground'} title={'Carrefour Mecque, Yaounde, Cameroon '}/>
